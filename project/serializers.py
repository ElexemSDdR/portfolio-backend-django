...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    technologies = serializers.ListField(required=True, allow_null=False, allow_empty=False, min_length=1, child=serializers.CharField(required=True, min_length=3))
